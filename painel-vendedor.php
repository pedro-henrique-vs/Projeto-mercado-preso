...
// Conta os produtos deste vendedor
$query_prod = "SELECT COUNT(*) as total_produtos FROM products WHERE vendedor_id = '$id_logado'";
...
<head>
    ...
    <title>Painel do Vendedor - MercadoPreso</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif; background-color: #f4f6f9; color: #333333; display: flex; min-height: 100vh; }
        .sidebar { width: 250px; background-color: #1e293b; color: #ffffff; display: flex; flex-direction: column; padding: 20px; }
        ...
        .nav-links a { color: #cbd5e1; text-decoration: none; font-size: 1rem; padding: 10px; border-radius: 8px; transition: background-color 0.2s; }
        ...
        .btn-inicio { background-color: #10b981; color: white; padding: 10px 20px; text-decoration: none; border-radius: 8px; font-weight: 600; transition: background-color 0.2s; }
        .btn-inicio:hover { background-color: #059669; }
        ...
        .card p { font-size: 2rem; font-weight: bold; color: #4f46e5; }
    </style>
</head>
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="nav-links">
            <li><a href="painel-vendedor.php" class="active">Meu Painel</a></li>
    ...
    <main class="main-content">
        <header>
            <h1>Painel do Vendedor: <?= htmlspecialchars($_SESSION['nome_usuario']) ?></h1>
            <div class="header-actions">
                <a href="#" class="btn-inicio">+ Novo Produto</a>
                <a href="index.php" class="btn-inicio" style="background-color: #3b82f6;">Ver Loja</a>
