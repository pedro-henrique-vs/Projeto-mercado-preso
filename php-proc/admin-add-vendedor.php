...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($tipo_pessoa === 'PF') {
        ...
        $query = "INSERT INTO vendedores (vend_nome, vend_email, vend_cpf, vend_dtnasc, tipo_pessoa, vend_cep, vend_logradouro, vend_numero, vend_bairro, vend_senha) 
                  VALUES ('$nome', '$email', '$cpf', '$data_nasc', '$tipo_pessoa', '$cep', '$logradouro', '$numero', '$bairro', '$senha')";
    } else {
        ...
        $query = "INSERT INTO vendedores (vend_razao_social, vend_nomefantasia, vend_cnpj, vend_inscricao_estadual, vend_email, tipo_pessoa, vend_cep, vend_logradouro, vend_numero, vend_bairro, vend_senha) 
                  VALUES ('$razao_social', '$nome_fantasia', '$cnpj', '$inscricao', '$email', '$tipo_pessoa', '$cep', '$logradouro', '$numero', '$bairro', '$senha')";
    }
